...
public class OdecaPopuniTim4 {
	...
	public void postConstruct(){
		...
		KorisnikTim4 k3 = dodajKorisnika("Mika", "Mikic", "miki@gmail.com", null, "miki", "miki");
		
		//PredmetTim4 p1 = dodajPredmet("majica", "S", "crvena", 500, "pamuk", "puma", "polovna dobro ocuvana majica", null);
		//OglasTim4 oglas = dodajOglas(k1, p1);
	}
	
	private KorisnikTim4 dodajKorisnika(String ime, String prezime, String email, byte[]avatar, String username, String password){
	...
	private PredmetTim4 dodajPredmet(String kategorija, String velicina, String boja, int pocetnaCena, String materijal, String marka, String opis, byte[] slika ){
